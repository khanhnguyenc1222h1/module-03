...
<head>
  ...
  <title>Friendlio Social Network</title>
  ...
  <div class="responsive-header">
    ...
    <nav id="menu" class="res-menu">
      <ul>
        <li><span>Home</span>
          <ul>
            <li><a href="index-2.jsp" title="">Home Social</a></li>
            <li><a href="index2.jsp" title="">Home Social 2</a></li>
            <li><a href="index-company.jsp" title="">Home Company</a></li>
            <li><a href="landing.jsp" title="">Login page</a></li>
            <li><a href="logout.jsp" title="">Logout Page</a></li>
            <li><a href="newsfeed.jsp" title="">news feed</a></li>
          </ul>
        </li>
